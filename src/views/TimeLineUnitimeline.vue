    ...
    uni_data: {
      ...
      default () {
        return [
          ...
          { title: '标题过长会显示省略号', content: '内容过长会隐藏' },
          { title: '更多效果可以自定义', content: '更多效果可以自定义' }
        ]
      }
    },
    space: { type: String, default: '100px' },
    uni_icon: { type: String, default: 'http://qiniu.iborge.cn/dian.png' }
  }
}
</script>
